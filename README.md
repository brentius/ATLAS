...
LICENSE.txt
```
## How does the Petrovascope work?
...
Petrovascope consists of 5 PCBs:
...
5. **PSU**. All good things need power, and the Petrovascope is no exception. It runs on 15V - my original design called for a 45V rail to drive the tip movement for maximum range, but I decided against it for redundancy's sake - this project is already complicated enough without splitting 3 power rails (10, 15 and 45V).
### Damping
...
## Assembly
*The instructions provided below are but a summary, and your Petrovascope will probably not work if you just follow these. For a more detailed set of instructions, or if you'd like to see how I did it, please refer to brentius.github.io/blog.*
...
#### Preparing the tip
Version 1 of the Petrovascope used a length of 80:20 Pt-Ir (platinum-iridium) wire that I simply cut at 45 degrees with a pair of sharp cutters. Boring, but it works.
# Meta Stuff
## Acknowledgements
# References
