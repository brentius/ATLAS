...
3. **PSU**. All good things need power, and ATLAS is no exception. It runs on 15V - my original design called for a 45V rail to drive the tip movement for maximum range, but I decided against it for redundancy's sake - this project is already complicated enough without splitting 3 power rails (10, 15 and 45V).
### Damping
